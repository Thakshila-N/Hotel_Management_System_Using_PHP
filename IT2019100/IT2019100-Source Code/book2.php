...
<!--date-->
var x=document.forms["form"]["arrival"].value;
if (x==null || x=="")
{
...
<!--rooms-->
var x=document.forms["form"]["departure"].value;
if (x==null || x=="")
{
alert("Please the departure date!!");
return false;
}
...
<div class="bordered">
	 ...
	 <form name="form" action="booktest2.php" style="margin-left:630px; margin-top:-530px; " method="post" onsubmit="return validateForm()" >
...
<input id="demoInput" type="number" name="nights" style="margin-left:30px;" placeholder="0" min=1 max=50>
  ...
  <br><br>
    ...
    <label for="departure" style="color:black; font-size:24px; margin-left:-60px;" name="departure" ><b>Departure:<b></label><br>
...
<br><br><br>
  <input type="submit" name="availability" style="background-color:orange; color:white; height:30px; margin-left:100px; " id="availability" value="BOOK NOW" />
